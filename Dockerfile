FROM cisl-repo/xdmod_distro:1.2
...
WORKDIR /
RUN patch -p1 </etc/patch/6.5-001.patch ; \
    patch -p1 </etc/patch/6.5-002.patch ; \
    patch -p1 </etc/patch/6.5-003.patch ; \
    patch -p1 </etc/patch/6.5-004.patch
